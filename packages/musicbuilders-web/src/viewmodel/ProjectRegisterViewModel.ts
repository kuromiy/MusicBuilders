...
export class ProjectRegisterViewModel {
  ...
  private _useCaseErrorViewModel: UseCaseErrorViewModel | null;
	...
	constructor(viewName: string, teamId: string, requestErrorViewModelList: Array<RequestErrorViewModel>, useCaseErrorViewModel: UseCaseErrorViewModel | null) {
